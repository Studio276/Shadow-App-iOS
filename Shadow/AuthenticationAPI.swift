...
class AuthenticationAPI: NSObject {
    ...
    func CheckAvailabilityOfUsername(dict:NSMutableDictionary,completion:@escaping completionBlock,errorBlock:@escaping ErrorBlock)
    {
        ...
        }, paramDict: dict, is_synchronous: false, url: "checkAvailabilityOfUserName")
   ...
   //APT To Verify Otp
    ...
    //APT To Verify Otp with phone number
  ...
  //API To Login
   ...
   //API To Log Out
    ...
    func SaveDataToUserDefaults(dict:NSDictionary)
    {
        ...
        let userName = dict.value(forKey: Global.macros.kUserName)as! String
