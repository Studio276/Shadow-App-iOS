...
class Global: NSObject {
    ...
    struct macros {
        ...
        static let kUsernameExist:String = "Username already exist."
        ...
        //Theme Color
        static let themeColor:UIColor = UIColor.init(red: 176.0/255.0, green: 93.0/255.0, blue: 206.0/255.0, alpha: 1.0)
