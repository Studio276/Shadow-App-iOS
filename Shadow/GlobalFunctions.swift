...
extension UIViewController {
    ...
    //Generate Lat Long
  /*  func lat_long(string:String) -> (String,String) {
  ...
  func add_padding(textfield:UITextField) {
    ...
    func SetButtonCustomAttributes (_ button:UIButton)
    {
        ...
        button.setTitleColor(Global.macros.themeColor, for: .normal)
        button.layer.cornerRadius = 5.0
        button.layer.borderWidth = 1.0
        button.clipsToBounds = true;
        button.layer.borderColor = Global.macros.themeColor.cgColor
    ...
    {
        button.backgroundColor = Global.macros.themeColor
...
class SwiftNotice: NSObject {
    ...
    static let rv = Global.macros.AppWindow//(UIApplication.sharedApplication().keyWindow?.subviews.first)! as UIView
